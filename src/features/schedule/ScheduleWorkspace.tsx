        ...
        {viewMode === "weekly" ? (
            <div className="rounded-[28px] border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
              ...
              <div className="mb-4 flex flex-wrap gap-2">
                {(["ON_SITE", "LIVE_ONLINE", "HYBRID"] as DeliveryMode[]).map((mode) => {
